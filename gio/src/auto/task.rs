...
impl Task {
    ...
    //pub fn return_new_error<'s, P: ToGlibPtr<'s, *const libc::c_char> + ?Sized + 's>(&self, domain: glib::Quark, code: i32, format: & 's P, : /*Unknown conversion*//*Unimplemented*/Fundamental: VarArgs) {
    ...
    //pub fn report_new_error<'s, P: FnOnce(Result<(), glib::Error>) + 'static, Q: ToGlibPtr<'s, *const libc::c_char> + ?Sized + 's>(source_object: Option<&glib::Object>, callback: P, source_tag: /*Unimplemented*/Option<Fundamental: Pointer>, domain: glib::Quark, code: i32, format: &'static Q, : /*Unknown conversion*//*Unimplemented*/Fundamental: VarArgs) {
