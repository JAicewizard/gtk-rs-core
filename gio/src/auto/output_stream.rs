...
pub trait OutputStreamExt: 'static {
    ...
    //fn printf<'s, P: IsA<Cancellable>, Q: ToGlibPtr<'s, *mut libc::c_char> + ?Sized + 's>(&self, cancellable: Option<&P>, error: &mut glib::Error, format: & 's Q, : /*Unknown conversion*//*Unimplemented*/Fundamental: VarArgs) -> Option<usize>;
    ...
    //fn vprintf<'s, P: IsA<Cancellable>, Q: ToGlibPtr<'s, *mut libc::c_char> + ?Sized + 's>(&self, cancellable: Option<&P>, error: &mut glib::Error, format: & 's Q, args: /*Unknown conversion*//*Unimplemented*/Unsupported) -> Option<usize>;
