...
impl Subprocess {
    ...
    //pub fn new<'s, P: ToGlibPtr<'s, *mut libc::c_char> + ?Sized + 's>(flags: SubprocessFlags, error: Option<&mut glib::Error>, argv0: & 's P, : /*Unknown conversion*//*Unimplemented*/Fundamental: VarArgs) -> Subprocess {
