...
pub trait ApplicationCommandLineExt: 'static {
    ...
    //fn print<'s, P: ToGlibPtr<'s, *mut libc::c_char> + ?Sized + 's>(&self, format: & 's P, : /*Unknown conversion*//*Unimplemented*/Fundamental: VarArgs);

    //#[doc(alias = "g_application_command_line_printerr")]
    //fn printerr<'s, P: ToGlibPtr<'s, *mut libc::c_char> + ?Sized + 's>(&self, format: & 's P, : /*Unknown conversion*//*Unimplemented*/Fundamental: VarArgs);
